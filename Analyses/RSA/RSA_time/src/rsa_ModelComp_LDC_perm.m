function [permuted_corr, permuted_betas, permuted_tvalues, cfg] = rsa_ModelComp_analysis( cfg, fv, RDMs, permute, model)
% Model-based RSA: 
...
for sub = 1 : nsub
    ...
    if cfg.classmodel.regress
        ...
        Y_matrix = [Y_matrix_bl',Y_matrix_cm',Y_matrix_cs',Y_matrix_ct']; %1 = block, 2 = complete, 3 = cues, 4 = content
    else
