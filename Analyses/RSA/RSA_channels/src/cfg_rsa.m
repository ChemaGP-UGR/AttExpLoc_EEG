...
%% IF Theoretical
cfg.study = [];
cfg.analysis = 'RSA_LDC';
cfg.location = 'D:\AttExpLoc_EEG\Results\EEG\Definitive\Voltage\RSA\LDC\Raw\3_conds\channels_only\';
...
% cfg.study = [];
% cfg.analysis = 'RSA_ctp';
% 
% cfg.location = 'D:\AttExpLoc_EEG\Results/EEG/CTP/Test/';
% 
