...
%% Basic configuration file for CTT analysis - Folder and data files:
...
cfg.location = 'D:\AttExpLoc_EEG\Results/EEG/Definitive/CTP/Loc_Cue/Exp/Av_100_300/p001/';

condition_a = 'loc_face'; % #1 faces and #2 names
condition_b = 'loc_name';
condition_c = 'cue_face_exp';
condition_d = 'cue_name_exp';


% Condition indentifiers:
cfg.study.conditionIdentifier{1,1} = condition_a;
cfg.study.conditionIdentifier{1,2} = condition_b;
cfg.study.conditionIdentifier{1,3} = condition_c;
cfg.study.conditionIdentifier{1,4} = condition_d;
...
cfg.study.dataPaths{1,3} = ['D:\AttExpLoc_EEG\Data\EEG\conditions\mat\' condition_c '/'] ; %[ ]
cfg.study.dataPaths{1,4} = ['D:\AttExpLoc_EEG\Data\EEG\conditions\mat\' condition_d '/'];
...
%% BALANCED DATASETS:
if strcmp(cfg.analysis,'RSA_ctp')||strcmp(cfg.analysis,'CTP')
